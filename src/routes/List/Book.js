...
export default class SearchList extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const { book : { data } } = nextProps;
    const { list } = data;
    let newList = list;
    if(status == 'delete'){
      this.setState({status : null});
      const { book : { e_data } } = nextProps;
      if(e_data.success){
        ...
        newList = this.redata(newList,nextProps.book.e_data);
      }else{
        notification['error']({
          message: '删除失败',
      ...
      if(e_data.success){
        ...
        newList = this.updata(newList,nextProps.book.e_data);
      ...
      if(e_data.success){
        ...
        newList = this.ctdata(newList,nextProps.book.e_data);
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="剧本类型">
        ...
        <UpdateForm {...updateParentMethods} modalVisible={up_visible} />
        <CreateForm {...createParentMethods} modalVisible={ct_visible} />
      </PageHeaderLayout>
    );
  }
}
